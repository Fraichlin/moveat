 ...
 */
final class Version20210308181128 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE administrateur (idAdmin INT AUTO_INCREMENT NOT NULL, login VARCHAR(254) DEFAULT \'NULL\', password VARCHAR(254) DEFAULT \'NULL\', nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, UNIQUE INDEX ADMINISTRATEUR_PK (idAdmin), PRIMARY KEY(idAdmin)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
